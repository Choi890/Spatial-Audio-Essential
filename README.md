...
**Research-oriented binaural spatial audio renderer for stereo music**  
현재 버전: **v1.11**
...
단순한 stereo widening이나 reverb 추가가 아니라, **원음 보존과 공간 확장을 동시에 만족시키는 렌더링 구조**를 만드는 것을 목표로 합니다.
